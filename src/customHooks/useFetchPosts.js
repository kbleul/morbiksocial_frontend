...
export const useFetchPosts = () => {
    ...
    const fetchPosts = useCallback( async () => { 
        ...
        let getpost = await fetch(`https://morbiksocial-api.cyclic.app/api/posts/timeline/all`, options)
        ...
        //get suggested posts
        getpost = await fetch(`https://morbiksocial-api.cyclic.app/api/posts/timeline/suggested`, options)
