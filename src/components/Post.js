    ...
    <div className="w-[90%] md:w-[60%] ml-[5%] md:ml-0 mt-40 md:mt-4 flex">
      ...
      <form onSubmit={e => handleSubmit(e)} encType="multipart/form-data" className="ml-4 w-4/5">
        ...
        <div className="flex justify-between items-center mt-1">
          ...
          <button className={isloading ? "w-[10%] md:w-[15%] px-1 md:px-4 bg-yellow-400 hover:bg-yellow-300 text-black text-sm md:text-base" : "w-1/5 md:w-1/4 px-1 md:px-4 bg-yellow-400 hover:bg-yellow-300 text-black text-sm md:text-base"}>Share</button>
